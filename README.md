...
|------|-------|-------|-----|------------|--------|
<!-- BOUNTY-TABLE-START -->
_Showing top 10 open bounties, sorted by RTC reward. Index rebuilt 2026-09-23T11:20:36.799029+00:00. For the live total, use the full bounty board link above._

| Repo | Issue | Title | RTC | Difficulty | Skills |
|------|-------|-------|-----|------------|--------|
| rustchain-bounties | [#16984](https://github.com/Scottcjn/rustchain-bounties/issues/16984) | Claim: May Flowers Star Pack — Blackcode-cmd | 5722881083 | critical | rust, social-media |
...
| rustchain-bounties | [#400](https://github.com/Scottcjn/rustchain-bounties/issues/400) | [SEASON 1] Harden the Forge — Security Season (750 RTC Po... | 750 | critical | documentation, rust, security |
...
| rustchain-bounties | [#681](https://github.com/Scottcjn/rustchain-bounties/issues/681) | 🏆 March Madness: Multi-Platform Engagement Challenge (Up ... | 200 | critical | rust, social-media |
<!-- BOUNTY-TABLE-END -->
...
| **wRTC** | Experimental Solana wrapper for RTC. The current RustChain docs list wRTC as live and swappable on Solana via a thin-liquidity Raydium pool, with the bridge at https://bottube.ai/bridge/wrtc. Treat wRTC as experimental infrastructure: liquidity is shallow, the RTC bounty reference rate is not a market-price guarantee, and native RTC remains earned on RustChain rather than sold by the project. |
